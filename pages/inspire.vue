<template>
  <v-container class="center">
    <v-row class="flex-center" sm="6">
      <v-col sm="12">
        <div class="valentines-day" @click="openCard">
          <div class="envelope"></div>
          <div class="heart"></div>
          <div class="text white--text">
            HAPPY <br />VALENTINE'S <br />DAY!<br />MY LOVE!
          </div>
          <div class="front"></div>
        </div>

        <v-dialog v-model="dialog" max-width="800px" height="auto">
          <template v-slot:activator="{ on }">
            <div @click="openCard" v-on="on"></div>
          </template>
          <v-card color="#FF80AB">
            <v-card-title>HAPPY VALENTINE'S DAY</v-card-title>
            <v-card-text class="white--text">
              ຂ້ອຍບໍ່ຮູ້ວ່າເຈົ້າຈະມັກມັນຫຼືບໍ່,
              <br />
              ຂ້ອຍບໍ່ມີຫຍັງໃຫ້ ບໍ່ມີດອກໄມ້ ບໍ່ໄດ້ເຫັນໜ້າ ບໍ່ໄດ້ພາເຈົ້າໄປທີ່
              ທີ່ເຈົ້າຢາກໄປ...
              <br />
              ຂ້ອຍເລີຍຕັ້ງໃຈເຮັດສິ່ງນີ້ຂຶ້ນມາເພື່ອເປັນຂອງແທນໃຈໃຫ້ເຈົ້າຄົນດຽວແລະມັນຈະເປັນຂອງເຈົ້າຄົນດຽວ💞
              <br />
              <v-spacer></v-spacer>
              <h4 class="text-right">Your Honey❤️</h4>
            </v-card-text>
          </v-card>
        </v-dialog>
...
export default {
  ...
  methods: {
    ...
    downloadCode() {
      // Your code to handle download here
    },
  },
}
</script>
